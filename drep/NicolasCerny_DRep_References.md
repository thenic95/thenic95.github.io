...
- **CIP-1694 Initial Governance Settings Report**  
  - *Description*: A detailed document outlining the initial governance parameter settings for the Cardano Mainnet commissioned by the Parameter and created by the Governance Parameter Working Group.  
  - *Link*: [CIP-1694 Initial Governance Settings Report](https://docs.google.com/document/d/1osTRntekCmiOrcEznSlwvPzN-cGAw-XKnmmZHNZbeok/edit?usp=sharing)

- **Delegate-Endorsed Cardano Constitution Draft**  
...
- **Masterclass: Mastering Protocol Parameters**  
  - *Description*: Learn about the importance of protocol parameters, their categorization (updatable and non-updatable), and how they shape Cardano's decentralized governance model. Diving into the roles of DReps, SPOs, and the Constitutional Committee, while providing actionable insights, tools, and resources to empower your governance participation.  
  - *Link*: [Mastering Protocol Parameters](https://youtu.be/eY3G1_lCqio?feature=shared)
...
- **Constitutional Workshop (Berlin 1)**  
  - *Description*: A recap of the first Berlin workshop on the Cardano Constitution.  
  - *Link*: [Constitutional Workshop (Berlin 1)](https://forum.cardano.org/t/recap-of-cardano-constitutional-workshop-building-a-sustainable-future-for-the-blockchain-ecosystem/134772)

- **Constitutional Workshop (Vienna)**  
  - *Description*: Insights from the Vienna workshop shaping the Cardano Constitution.  
  - *Link*: [Constitutional Workshop (Vienna)](https://forum.cardano.org/t/shaping-the-cardano-constitution-constitutional-workshop-vienna-2024/137193)
